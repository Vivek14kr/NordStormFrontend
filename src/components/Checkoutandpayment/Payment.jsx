...
export const Payment = () => {
  ...
  function getUserData() {
      ...
      fetch("https://nordstormbc.onrender.com/login")
        .then((d) => d.json())
        .then((res) => {
  ...
  const handleClick = (e) => {
    ...
    axios.post("https://nordstormbc.onrender.com/create", newNote);
    fetchItems();
  };
  ...
  const fetchItems = () => {
    axios.get("https://nordstormbc.onrender.com/tweets").then((res) => {
      ...
      <div id="mainbox">
        <div id="box1">
          <div>
            ...
            <div>
              <Link to="/orderConfirm" style={{ margin: "10px" }}>
            ...
            <div id="infod">
              <div className="box1">
                <ShoppingCartOutlinedIcon
                  sx={{ fontSize: "26px", paddingLeft: "20px" }}
                />
